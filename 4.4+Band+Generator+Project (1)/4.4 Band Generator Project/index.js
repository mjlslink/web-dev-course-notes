...
app.post("/submit", (req, res) => {
  ...
  const adjChoiceIndex = Math.floor(Math.random() * adj.length) +1 ;
  const adjChoice = adj[adjChoiceIndex];
  const nounCHoiceIndex = Math.floor(Math.random() * noun.length)+1;
  const nounChoice = noun[nounCHoiceIndex];

  console.log(adjChoiceIndex);
  console.log(adjChoice);

  res.render("index.ejs", {noun: nounChoice, adj: adjChoice});
